            ...
            when (and (typep widget '<combo-box>)
              ...
              do (progn
                   ...
                   (setf (scrollbar-dragging-p widget) nil
                         (scrollbar-drag-offset widget) 0))))
