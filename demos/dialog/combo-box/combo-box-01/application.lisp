...
(defclass <combo-box-01-app> (mnas-sdl3-gui/app:<app>)
  ((small-widget
...
(defmethod mnas-sdl3-gui/app:finalize-application ((application <combo-box-01-app>) &optional result)
  ...
  (when (<combo-box-01-app>-small-widget application)
    (mnas-sdl3-gui/widgets:disable-popup-window (<combo-box-01-app>-small-widget application)))
  (when (combo-box-01-large-widget application)
    (mnas-sdl3-gui/widgets:disable-popup-window (combo-box-01-large-widget application)))
