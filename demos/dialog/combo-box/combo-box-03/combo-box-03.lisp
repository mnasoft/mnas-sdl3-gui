  ...
  (unless *combo-box-03-open* (return-from combo-box-03-demo-iterate :success))
     ...
     *combo-box-03-renderer*
     (format nil "expanded=~A popup=~A enabled=~A popup-id=~S"
       ...
       (mnas-sdl3-gui/widgets:popup-visible-p (mnas-sdl3-gui/widgets:popup-widget *combo-box-03-editable*))
...
(sdl3:def-app-quit combo-box-03-demo-quit (result)
  ...
  (when *combo-box-03-window* (mnas-sdl3-gui/widgets:destroy-window-and-unregister *combo-box-03-window*))
