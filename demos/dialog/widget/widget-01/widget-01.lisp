...
(defun sync-command-state ()
  ...
  (let ((flat
          (mnas-sdl3-gui/commands:find-command :widget-01/style-flat))
        (windows
          (mnas-sdl3-gui/commands:find-command :widget-01/style-windows))
        (motif
          (mnas-sdl3-gui/commands:find-command :widget-01/style-motif))
        (clear
          (mnas-sdl3-gui/commands:find-command :widget-01/clear-entry))
        (entry
          (entry-widget)))
    (when flat
